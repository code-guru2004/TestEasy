...
export function SimpleEditor({ content: initialContent = "", onUpdate }: { content?: string; onUpdate?: (params: { editor: any }) => void }) {
  ...
  const editor = useEditor({
    // Keep this for SSR compatibility
    ...
    extensions: [
      StarterKit.configure({
        ...
        // Ensure paragraph is properly configured
        paragraph: {
          HTMLAttributes: {
    ...
    editable: true,
    // Don't autofocus to prevent issues
    autofocus: false,
  ...
  useEffect(() => {
    if (editor && initialContent !== undefined && isMounted) {
  ...
  // Don't render editor on server to avoid hydration issues
  if (!isMounted) {
    return (
      <div className="simple-editor-wrapper">
        <div className="simple-editor-content">
          <div className="tiptap ProseMirror simple-editor" style={{ minHeight: '400px', padding: '1rem' }}>
            {initialContent ? (
